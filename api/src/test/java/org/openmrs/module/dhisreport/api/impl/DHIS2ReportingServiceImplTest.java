...
public class DHIS2ReportingServiceImplTest
	...
	//
	//	@Test
	//	public void shouldGenerateReportingReportDefinition() throws Exception {
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	...
	//
	//			ReportDefinitionService service = Context
	...
	//
	//			DataValueSet dvs = dhis2ReportingService
	//					.generateReportingReportDefinition(rd, period, location);
	...
	//
	//	@Test
	//	public void shouldunMarshallandSaveReportTemplates() throws Exception {
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	//		dhis2ReportingService.unMarshallandSaveReportTemplates(resource
	//				.getInputStream());
	...
	//
	//	@Test
	//	public void shouldsaveReportTemplates() throws Exception {
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	//
	//		dhis2ReportingService.unMarshallandSaveReportTemplates(resource
	...
	//
	//	@Test
	//	public void shouldgetLocationByOrgUnitCode() throws Exception {
	...
	//		attributetype
	//				.setDescription("Corresponding Value of ORG UNITS for DHIS");
	//		attributetype.setMinOccurs(0);
	//		attributetype.setMaxOccurs(1);
	//		attributetype
	//				.setDatatypeClassname("org.openmrs.customdatatype.datatype.FreeTextDatatype");
	...
	//
	//		Location l = dhis2ReportingService
	//				.getLocationByOrgUnitCode("dhis2OrgUnitCode");
	//		assertEquals(loc, l);
