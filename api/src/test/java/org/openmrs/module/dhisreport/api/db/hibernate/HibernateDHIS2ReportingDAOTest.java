...
public class HibernateDHIS2ReportingDAOTest
		extends
	...
	//	@Test
	//	public void shouldsaveReportDefinitionObjectIfObjectPreExits()
	//			throws Exception {
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	//		dhis2ReportingService.unMarshallandSaveReportTemplates(resource
	//				.getInputStream());
	//
	//		ReportTemplates reportTemplates = dhis2ReportingService
	//				.getReportTemplates();
	//		List<ReportDefinition> rds = reportTemplates.getReportDefinitions();
	...
	//	@Test
	//	public void shouldsaveReportDefinitionObjectIfObjectDoesNotPreExits()
	//			throws Exception {
	//
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	...
	//
	//	@Test
	//	public void shouldsaveDataElementObjectTestIfDataElementPreExist()
	//			throws Exception {
	//
	//		ClassPathResource resource = new ClassPathResource(
	//				"reportDefinition.xml");
	...
	//
	//	@Test
	//	public void shouldsaveDataElementObjectTestIfDataElementDoesNotPreExist()
	//			throws Exception {
	//
	...
	//
	//		List<ReportDefinition> reportdef = reportTemplates
	//				.getReportDefinitions();
	//
	//		for (ReportDefinition rd : reportdef) {
	//
	//			Set<DataValueTemplate> datavaluetemplates = rd
	...
	//		ReportDefinition rd1 = dao.getReportDefinitionByUid(datavaluetemplate
	//				.getReportDefinition().getUid());
	//		DataElement de1 = dao.getDataElementByUid(datavaluetemplate
	//				.getDataelement().getUid());
	//		Disaggregation dis1 = dao.getDisaggregationByUid(datavaluetemplate
	//				.getDisaggregation().getUid());
	//		Criteria criteria = dao.getSessionFactory().getCurrentSession()
	//				.createCriteria(DataValueTemplate.class);
	//		criteria.add(Restrictions.eq("reportDefinition", rd1)).add(
	//				Restrictions.eq("dataelement", de1)).add(
	//				Restrictions.eq("disaggregation", dis1));
